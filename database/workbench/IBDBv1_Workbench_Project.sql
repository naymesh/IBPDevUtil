...
-- Naymesh : added group_name column based on Install4j code statement diff. Consistent with corresponding bean (org.generationcp.middleware.pojos.workbench.Tool) in middleware too.
-- Naymesh : added two enums based on Install4j code statement diff
--
